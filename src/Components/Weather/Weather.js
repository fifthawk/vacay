...
const Weather = () => {
    ...
    let weatherDisplay;
    icon[0]?.description === 'broken clouds' ? weatherDisplay = '🌥️' :
    icon[0]?.description === 'clear sky' ? weatherDisplay = '☀️':
    icon[0]?.description === 'few clouds' ? weatherDisplay = '🌤️' :
    icon[0]?.description === 'scattered clouds' ? weatherDisplay = '☁️':
    icon[0]?.description === 'shower rain' ? weatherDisplay = '🌧️' :
    icon[0]?.description === 'rain' ? weatherDisplay = '🌧️' :
    icon[0]?.description === 'thunderstorm' ? weatherDisplay = '⛈️' :
    weatherDisplay = '🌫️'
    ...
    return(
        <div className = 'weatherContainer'>
         ...
         <p>Humidity: {weather.humidity !== undefined &&weather.humidity}%</p>
